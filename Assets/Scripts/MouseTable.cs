...
public class MouseTable : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_assistanceStimulateLevel1View = gameObject.transform.Find("MouseChallengeCleanTableAssistanceStimulateLevel1");
    ...
    /*public bool isAssistanceStimulateLevel1Active()
    {
        return m_assistanceStimulateLevel1View.gameObject.activeSelf;
    }

    public bool isAssistanceReminderActive()
    {
        return m_assistanceReminderView.gameObject.activeSelf;
    }*/
}
