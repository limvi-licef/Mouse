...
public class MouseCueing : MouseAssistanceButtonAbstract
{
    ...
    {
        // Callback
        MouseUtilities.mouseUtilitiesAddTouchCallback(m_hologramButtonClicked, callbackButtonHelpClicked);
    }
    ...
    void callbackButtonHelpClicked()
    {
        ...
        MouseDebugMessagesManager.Instance.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Info, "Clicked");
    }
    ...
    public override void show (EventHandler eventHandler)
    {
        if (m_mutexShow == false)
        {
            ...
            m_text.gameObject.AddComponent<MouseUtilitiesAnimation>().animateAppearInPlace(new EventHandler(delegate (System.Object o, EventArgs e) {
                ...
                m_button.gameObject.AddComponent<MouseUtilitiesAnimation>().animateAppearInPlace(temp);
    ...
    public override void hide (EventHandler eventHandler)
    {
        if (m_mutexHide == false)
        {
            ...
            m_text.gameObject.AddComponent<MouseUtilitiesAnimation>().animateDiseappearInPlace(new EventHandler(delegate (System.Object o, EventArgs e) {
                EventHandler[] temp = new EventHandler[] {new EventHandler(delegate (System.Object oo, EventArgs ee) {
                    Destroy(m_button.gameObject.GetComponent<MouseUtilitiesAnimation>());
                    m_mutexHide = false;
            }), eventHandler };

                m_button.gameObject.AddComponent<MouseUtilitiesAnimation>().animateDiseappearToPosition(m_button.position, temp);
