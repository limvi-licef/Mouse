...
public class MouseChallengeCleanTableV2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //m_reminderController.addObjectToBeClose(m_solu)
        //m_reminderController.addObjectToBeClose(m_solution);
        ...
        {
            if (/*m_containerTableController.increaseGradationAssistanceStimulateLevel1()*/ m_assistancePicturalController.increaseGradation() == false)
            {
                m_timer.m_timerDuration = 20;
            ...
            { // Means we have reached the last level
                ...
                //TODO m_containerTableController.increaseGradationAssistanceReminder();
            }
        });
    ...
    void initializeScenario1()
    {
        ...
        //MouseUtilitiesGradationAssistance sReminderRag = m_assistanceGradationManager.addNewAssistanceGradation("ReminderRag");
        //setReminderRagTransitions(sReminderRag);
        ...
        //m_containerRagController.m_eventHologramHelpButtonCueingTouched += sMessageCue.addGradationNext(sArchToRag);
        m_assistanceCueingController.m_eventHelpButtonClicked += sMessageCue.addGradationNext(sArchToRag);
        //m_containerRagController.m_eventHologramReminderClockTouched += sArchToRag.addGradationNext(sReminderRag);
        //m_containerTableController.m_eventReminderClockTouched += sArchToRag.addGradationNext(sReminderCubeRagTable);
        //m_containerRagController.m_eventHologramReminderBackTouched += sReminderRag.setGradationPrevious(); 
        //m_containerRagController.m_eventHologramReminderOkTouched += sReminderRag.addGradationNext(sStandBy);
        /*m_containerRagController.m_eventHologramHelpButtonTouched*/ m_assistanceConnectWithArchController.m_eventHologramHelpTouched += sArchToRag.addGradationNext(sSolution);
        ...
        //m_containerRagController.m_eventHologramReminderClockTouched += sSolution.addGradationNext(sReminderRag);
    ...
    {
        state.addFunctionShow(/*m_containerTableController.showAssistanceStimulateLevel1*/ m_assistancePicturalController.show, MouseUtilities.getEventHandlerWithDebugMessage(m_debug, "Assistance stimulate level 1 should be displayed now"));
        ...
        state.setFunctionHide(/*m_containerTableController.hideAssistanceStimulateLevel1*/ m_assistancePicturalController.hide, MouseUtilities.getEventHandlerEmpty());
    }
    ...
    void setReminderTableTransitions(MouseUtilitiesGradationAssistance state)
    {
        state.addFunctionShow(delegate (EventHandler e)
        {
            ...
            //if (m_assistanceGradationManager.getGradationCurrent() == )

        }, MouseUtilities.getEventHandlerEmpty());
        //state.addFunctionShow(m_containerRagController.hideAssistanceReminder, MouseUtilities.getEventHandlerEmpty());
    ...
    void setMessageCueTransitions(MouseUtilitiesGradationAssistance state)
    {
        ...
        /*state.setFunctionHide(delegate (EventHandler ee)
        {
            ee?.Invoke(this, EventArgs.Empty);
        }, MouseUtilities.getEventHandlerEmpty());*/
    }
    ...
    void setConnectWithArchTransitions(MouseUtilitiesGradationAssistance state)
    {
        ...
        state.addFunctionShow(/*m_containerRagController.showAssistanceStimulateLevel2*/ m_assistanceConnectWithArchController.show, MouseUtilities.getEventHandlerEmpty());
        state.addFunctionShow(m_reminderController.show, MouseUtilities.getEventHandlerEmpty());
        //state.addFunctionShow(m_containerRagController.showAssistanceReminder, MouseUtilities.getEventHandlerEmpty());

       state.setFunctionHide(m_assistanceConnectWithArchController.hide, MouseUtilities.getEventHandlerEmpty());

        //state.setFunctionHide(/*m_containerRagController.hideAssistanceStimulateLevel2*/ m_assistanceStimulateLevel2Controller.hide, MouseUtilities.getEventHandlerEmpty());

        /*state.setFunctionHide(delegate(EventHandler e)
        {
            m_debug.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Info, "Temp disabling hiding arch for debug purposes");
    ...
    /*void setReminderRagTransitions(MouseUtilitiesGradationAssistance state)
    {
        state.addFunctionShow(delegate (EventHandler e)
        {
            //m_containerTableController.hideAssistanceReminder(MouseUtilities.getEventHandlerEmpty());
        ...
        //state.setFunctionHide(m_containerRagController.hideAssistanceReminder, MouseUtilities.getEventHandlerEmpty());
    }*/

    void setSolutionTransitions(MouseUtilitiesGradationAssistance state)
    {
        state.addFunctionShow(/*m_containerRagController.showAssistanceSolution*/ m_assistanceSolutionController.show, MouseUtilities.getEventHandlerEmpty());
        state.addFunctionShow(m_reminderController.show, MouseUtilities.getEventHandlerEmpty());

        state.setFunctionHide(/*m_containerRagController.hideAssistanceSolution*/ m_assistanceSolutionController.hide, MouseUtilities.getEventHandlerEmpty());
    }
