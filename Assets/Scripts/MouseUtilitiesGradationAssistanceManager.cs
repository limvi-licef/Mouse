...
public class MouseUtilitiesGradationAssistanceManager
{
    ...
    public MouseUtilitiesGradationAssistanceIntermediateState addIntermediateState(string id, MouseUtilitiesGradationAssistance nextState)
    {
        ...
        {
            MouseDebugMessagesManager.Instance.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Warning, "Intermediate state already registered - returning the existing state");
        }
...
public class MouseUtilitiesGradationAssistanceIntermediateState: MouseUtilitiesGradationAssistanceAbstract
{
    ...
    public EventHandler addState(MouseUtilitiesGradationAssistance state)
    {
        ...
        {
            MouseDebugMessagesManager.Instance.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Warning, "State already registered - returning the callback already registered for this state");
    ...
    {
        MouseDebugMessagesManager.Instance.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Info, "Trying to trigger the next state");
        ...
        if (triggerNextState)
        {
            ...
            MouseDebugMessagesManager.Instance.displayMessage(MethodBase.GetCurrentMethod().ReflectedType.Name, MethodBase.GetCurrentMethod().Name, MouseDebugMessagesManager.MessageLevel.Info, "All intermediate states have called, going to the next state!");
